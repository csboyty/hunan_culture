var videosUpdate=(function(config,functions){
    return{
            ...
            $(form).ajaxSubmit({
                ...
                success:function(response){
                    if(response.data.success){
                        ...
                        setTimeout(function(){
                            window.location.href="admin/article/article_video";
                        },3000);
                    }else{
        ...
        uploadedCb:function(file,info){
            ...
            $.get(info.url+"?imageInfo",function(data){
                ...
                if(data.width==300&&data.height==200){
                    ...
                    $().toastmessage("showErrorToast",config.messages.imageError300x200);
                }
