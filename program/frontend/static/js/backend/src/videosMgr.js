var videosMgr=(function(config,functions){
    ...
    function createTable(){
        ...
        var ownTable=$("#myTable").dataTable({
            ...
            "aoColumns": [
                ...
                { "mDataProp": "opt",
                    "fnRender":function(oObj){
                        return '<a href="admin/article/article_video/'+oObj.aData.id+'/update">修改</a>&nbsp;'+
...
$(document).ready(function(){
    ...
    videosMgr.createTable();

    $("#searchBtn").click(function(e){
        videosMgr.tableRedraw();
    });

    $("#myTable").on("click","a.delete",function(){
        videosMgr.delete($(this).attr("href"));
        return false;
    });
});
